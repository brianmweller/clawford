...
- If you *also* want Lowly to watch a social channel (LinkedIn, X, Bluesky, etc.) for filtered notifications and consolidated DMs, that's an optional extension covered in [Ch 11](11-lowly-worm-social.md). **The core newsfeed stands on its own and is useful without any of that.** Deploy this chapter first; add [Ch 11](11-lowly-worm-social.md) only if you care about the social half.
