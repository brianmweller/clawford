...
- [`agents/fix-it/SOUL.md.example`](../agents/fix-it/SOUL.md.example) — the full values and boundaries document, including the Diagnostic Discipline section that exists because of the probation incident.
